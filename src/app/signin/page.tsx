...
export default function SignInPage() {
    return (
        <AuthShell
            title="Sign in"
            subtitle="Sign in is required to create and manage cases on this device."
            footerLink={{
                text: "No account?",
        ...
        >
            <Suspense fallback={<div className="h-32 flex items-center justify-center text-sm text-zinc-500">Loading auth...</div>}>
                <SignInForm />
            </Suspense>
        </AuthShell>
    );
