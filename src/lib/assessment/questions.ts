...
export function buildQuestions(ctx: Ctx): Question[] {
    ...
    const qs: Question[] = [
        ...
        },
        {
            ...
            help: "The main reference number on the notice (e.g. 'PCN No.' or 'Ref').",
            type: "text",
            group: "CORE",
        },
        {
            ...
            key: "pcn_number",
            label: "PCN Number",
            help: "The Penalty Charge Notice number, usually prominent at the top of the notice.",
            type: "text",
            required: true,
            when: (c) => c.disputeType === "COUNCIL_PCN" || c.disputeType === "PRIVATE_PARKING",
            group: "CORE",
        },
        {
            id: "notice_date",
        ...
        },
        {
            ...
            key: "time_of_issue",
            label: "Time of Issue",
            help: "The time shown on the notice (e.g. '14:35'). Look near the date or in contravention details.",
            type: "text",
            group: "CORE",
        },
        {
        ...
        },
        {
            ...
            help: "The street name or car park location listed on the notice.",
            type: "text",
            required: true,
            group: "CORE",
        },
        {
            ...
            help: "The registration plate number of the vehicle.",
            type: "text",
            required: true,
            group: "CORE",
        },
